    ...
    <div class="">
        <div class="row">
            <div class="main-menu-chi">
                <div class="col-md-5">
                    <a href="<?php echo base_url('/health_view/functionality/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-green">
                    ...
                    <a href="<?php echo base_url('/health_view/exterior/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-red">

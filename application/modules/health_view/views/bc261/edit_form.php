<div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            <!-- form start -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url('/bckeluar/bckeluar_261/edit/') . '/' . $data_dokumen['id']; ?>"  method="post">
              <div class="box-body">
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            ...
                            <input type="hidden" name="nama_penerima" id="nama_penerima" value="<?php echo $data_dokumen['nama_penerima'];?>"/>
                          </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <thead>
                       	...
                       	<tbody class="my-data-barang">
                            ...
                            <tr class="text-data-barang">
                                <td>
                                    <input type="hidden" name="id_detail[]" value="<?php echo $dokumen_detail['id'];?>" readonly />
                                ...
                                <td>
                                    <input name="jml_brg[]" type="text" class="form-control input-sm col-sm-12" placeholder="Jumlah" value="<?php echo $dokumen_detail['jumlah_brg'];?>" style="text-align: right;"/>
                                </td>  
                                <td>
                                    <input name="satuan_brg[]" type="text" class="form-control input-sm col-sm-12" value="<?php echo $dokumen_detail['satuan_dok'];?>" readonly/>                           
                                </td>  
                                <td><input name="bb_brg[]" type="text" class="form-control input-sm col-sm-12" placeholder="Berat Bersih (Kg)" value="<?php echo $dokumen_detail['berat_bersih'];?>" style="text-align: right;"/></td>                                            
                                <td><input name="cif_brg[]" type="text" class="form-control  input-sm col-sm-12" placeholder="Nilai CIF"  value="<?php echo $dokumen_detail['nilai_cif_brg'];?>" style="text-align: right;"/></td>
                      		...
                      		<tr class="text-data-barang">
                                <td>
                                    <select class="form-control select2 input-sm col-sm-12" id="jenis_brg">
                                      ...
                                      <?php foreach($barang_data as $barang): ?>
                                        <option value="<?php echo $barang->kode;?>"><?php echo $barang->nama;?></option>
                                      <?php endforeach; ?>
                                    </select>    
                                </td>  
                                <td>
                                ...
                                <td>
                                    <select class="form-control select2 input-sm col-sm-12" id="satuan_brg">
                                      ...
                                      <?php foreach($jenis_satuan as $satuan): ?>
                                        <option value="<?php echo $satuan->id;?>"><?php echo $satuan->kode;?></option>
                                      <?php endforeach; ?>
                                    </select>                                
                                </td>  
              ...
              <div class="box-footer">
                <input type="hidden" name="id" class="form-control input-sm" value="<?php echo $data_dokumen['id'];?>" />

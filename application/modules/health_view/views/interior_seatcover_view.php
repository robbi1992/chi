...
<section class="content">
    ...
    <div class="row">
                ...
                <div class="box-body no-padding">
                  <table class="table table-bordered table-striped">
                    ...
                    <?php
                        $tag_html = '';
                        $list_reg = array(
                                            'A/C Type' => array('AIRBUS'),
                                            'A/C Reg' => array('330'),
                                            'Date' => array('30-Sept-2014'),
                                            'Score' => array('0'),
                                            'Inspect By' => array('Ari'),
                                            'Bottom' => array('0'),
                                            'Backrest' => array('0'),
                                            'Headrest' => array('0'),
                                            'Pocket' => array('0'),
        ...
        <div class="col-md-3">
            ...
            <a href="<?php echo base_url("/health_view/interior_seatcover/" . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-blue">
                <i class="fa fa-chevron-circle-right"></i> Seat Cover
            </a>
            <a href="<?php echo base_url("/health_view/interior_carpet/" . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-red">

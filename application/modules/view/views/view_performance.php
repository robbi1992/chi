...
<section class="content">
	<div class="row">
		<div class="col-md-5">
            ...
            -->
			<a href="<?php echo site_url('/view/functionality/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-green">
                <i class="fa fa-chevron-circle-right"></i> Functionality
                <span>(<?php echo (isset($func)) ? $func : '100';?> %)</span>
            </a>
			<a href="<?php echo site_url('/view/interior/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-green">
                <i class="fa fa-chevron-circle-right"></i> Interior Appereance

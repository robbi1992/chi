...
<script src="<?php echo base_url();?>assets/plugins/uploader/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="<?php echo base_url();?>assets/plugins/uploader/js/jquery.fileupload-video.js"></script>
...
<script type="text/javascript">
    var myBaseUrl = '<?php echo base_url();?>uploader';
</script>

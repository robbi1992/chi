    ...
    <div class="">
        <div class="row">
            <div class="main-menu-chi">
                <div class="col-md-5">
                    <a href="<?php echo site_url('/health_input/functionality/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-green">
                    ...
                    -->
                    <!--
                    <a href="<?php echo site_url('/input/interior/' . url_title('B777-300') .'/'. url_title('PK-GIA')); ?>" class="btn btn-lg btn-block btn-social bg-<?php echo performance_color($interior_value);?>">
                        <i class="fa fa-chevron-circle-right"></i> Interior Appereance
                    </a>
                    <a href="<?php echo site_url('/health_input/exterior/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social <?php echo bg_pt_exterior($exterior_performance['scoring']); ?>">
                        <i class="fa fa-chevron-circle-right"></i> Exterior Appereance
                    </a>
                    -->
                    <a href="<?php echo site_url('/input/interior/' . url_title('B777-300') .'/'. url_title('PK-GIA')); ?>" class="btn btn-lg btn-block btn-social bg-green">
                        <i class="fa fa-chevron-circle-right"></i> Interior Appereance (99.95%)
                    </a>
                    <!--
                    <a href="<?php echo site_url('/health_input/exterior/' . url_title($typeac) .'/'. url_title($typereg)); ?>" class="btn btn-lg btn-block btn-social bg-green">

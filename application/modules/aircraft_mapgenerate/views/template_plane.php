...
<script>
	...
	$().ready(function(){
    	...
    	$("#imgInp").change(function(){    	       	   
            readURL(this);            
            //$( "<map name='MapAirCraft' id='MapAirCraft'></map>" ).insertAfter( $( ".images" ) );
             $('.images').show(); 
            resizeHtml();
            loadImagemapGenerator(width,height);
		    container.empty();                            
        });
       // $("#ImageAirCraft").mousedown(function (e) {
//            handleMouseDown(e);
//
//        });       
        
        $('.my-content-coordinate').on('click', '.remove-box', function(e){
            $(this).parent().parent().css( 'background-color', '#FF6C6C' );
                $(this).parent().fadeOut("slow", function() {
                    $(this).parent().remove();
                    $('.number-content-coordinate').each(function(index){
                        var index2 = $(this).text( index + 1 );                    
                        alert(index2);
                    });
                    
                        //$('.number-content-coordinate').each(function(index){
//                              var index = parseInt($(this).text(index));
//                              index = index - 1;
//                              alert(index);
//                              return false;
//                              $('#mapContainer').find('area#area'+ index).remove();
//    		                  hightlight();
//                        });
                    });
                return true;
...
<section class="content">
    <div class="row">  
        ...
        <div class="col-md-12">
            <img src="<?php echo base_url(); ?>assets/images/B777-GIA-GIG.jpg" id="ImageAirCraft" class="imgmapMainImage" alt="" usemap="#map"/>
            <map name="map" id="map">
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area9" onclick="return checkCoord(9);" class="area test" shape="circle" coords="229,80,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area12" onclick="return checkCoord(12);" class="area test" shape="circle" coords="229,114,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area17" onclick="return checkCoord(17);" class="area test" shape="circle" coords="247,154,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area18" onclick="return checkCoord(18);" class="area test" shape="circle" coords="266,162,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area19" onclick="return checkCoord(19);" class="area test" shape="circle" coords="351,79,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area20" onclick="return checkCoord(20);" class="area test" shape="circle" coords="369,86,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area21" onclick="return checkCoord(21);" class="area test" shape="circle" coords="387,79,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area22" onclick="return checkCoord(22);" class="area test" shape="circle" coords="406,87,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area23" onclick="return checkCoord(23);" class="area test" shape="circle" coords="424,79,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area24" onclick="return checkCoord(24);" class="area test" shape="circle" coords="443,86,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area25" onclick="return checkCoord(25);" class="area test" shape="circle" coords="461,79,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area26" onclick="return checkCoord(26);" class="area test" shape="circle" coords="351,115,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area27" onclick="return checkCoord(27);" class="area test" shape="circle" coords="368,106,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area28" onclick="return checkCoord(28);" class="area test" shape="circle" coords="387,114,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area29" onclick="return checkCoord(29);" class="area test" shape="circle" coords="406,107,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area30" onclick="return checkCoord(30);" class="area test" shape="circle" coords="423,116,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area31" onclick="return checkCoord(31);" class="area test" shape="circle" coords="443,109,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area32" onclick="return checkCoord(32);" class="area test" shape="circle" coords="461,114,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area33" onclick="return checkCoord(33);" class="area test" shape="circle" coords="351,125,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area34" onclick="return checkCoord(34);" class="area test" shape="circle" coords="371,133,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area35" onclick="return checkCoord(35);" class="area test" shape="circle" coords="388,125,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area36" onclick="return checkCoord(36);" class="area test" shape="circle" coords="406,135,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area37" onclick="return checkCoord(37);" class="area test" shape="circle" coords="423,126,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area38" onclick="return checkCoord(38);" class="area test" shape="circle" coords="443,132,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area39" onclick="return checkCoord(39);" class="area test" shape="circle" coords="459,125,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area51" onclick="return checkCoord(51);" class="area test" shape="circle" coords="487,121,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area56" onclick="return checkCoord(56);" class="area test" shape="circle" coords="502,77,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area59" onclick="return checkCoord(59);" class="area test" shape="circle" coords="501,111,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area62" onclick="return checkCoord(62);" class="area test" shape="circle" coords="502,146,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area67" onclick="return checkCoord(67);" class="area test" shape="circle" coords="516,94,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area71" onclick="return checkCoord(71);" class="area test" shape="circle" coords="516,145,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area78" onclick="return checkCoord(78);" class="area test" shape="circle" coords="577,77,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area84" onclick="return checkCoord(84);" class="area test" shape="circle" coords="577,145,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area86" onclick="return checkCoord(86);" class="area test" shape="circle" coords="577,164,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area99" onclick="return checkCoord(99);" class="area test" shape="circle" coords="598,111,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area101" onclick="return checkCoord(101);" class="area test" shape="circle" coords="598,130,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area114" onclick="return checkCoord(114);" class="area test" shape="circle" coords="631,79,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area119" onclick="return checkCoord(119);" class="area test" shape="circle" coords="624,129,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area120" onclick="return checkCoord(120);" class="area test" shape="circle" coords="629,145,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area137" onclick="return checkCoord(137);" class="area test" shape="circle" coords="651,110,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area138" onclick="return checkCoord(138);" class="area test" shape="circle" coords="658,75,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area150" onclick="return checkCoord(150);" class="area test" shape="circle" coords="684,77,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area152" onclick="return checkCoord(152);" class="area test" shape="circle" coords="685,94,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area159" onclick="return checkCoord(159);" class="area test" shape="circle" coords="697,76,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area162" onclick="return checkCoord(162);" class="area test" shape="circle" coords="692,111,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area170" onclick="return checkCoord(170);" class="area test" shape="circle" coords="712,95,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area171" onclick="return checkCoord(171);" class="area test" shape="circle" coords="704,112,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area180" onclick="return checkCoord(180);" class="area test" shape="circle" coords="717,111,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area183" onclick="return checkCoord(183);" class="area test" shape="circle" coords="725,144,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area185" onclick="return checkCoord(185);" class="area test" shape="circle" coords="725,163,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area200" onclick="return checkCoord(200);" class="area test" shape="circle" coords="798,164,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area212" onclick="return checkCoord(212);" class="area test" shape="circle" coords="825,94,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area221" onclick="return checkCoord(221);" class="area test" shape="circle" coords="841,94,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area236" onclick="return checkCoord(236);" class="area test" shape="circle" coords="866,77,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area251" onclick="return checkCoord(251);" class="area test" shape="circle" coords="879,147,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area263" onclick="return checkCoord(263);" class="area test" shape="circle" coords="908,78,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area276" onclick="return checkCoord(276);" class="area test" shape="circle" coords="913,112,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area281" onclick="return checkCoord(281);" class="area test" shape="circle" coords="921,163,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area283" onclick="return checkCoord(283);" class="area test" shape="circle" coords="935,87,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area285" onclick="return checkCoord(285);" class="area test" shape="circle" coords="928,112,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area286" onclick="return checkCoord(286);" class="area test" shape="circle" coords="928,121,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area291" onclick="return checkCoord(291);" class="area test" shape="circle" coords="947,78,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area293" onclick="return checkCoord(293);" class="area test" shape="circle" coords="947,95,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area295" onclick="return checkCoord(295);" class="area test" shape="circle" coords="940,121,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area297" onclick="return checkCoord(297);" class="area test" shape="circle" coords="946,146,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area303" onclick="return checkCoord(303);" class="area test" shape="circle" coords="954,112,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area305" onclick="return checkCoord(305);" class="area test" shape="circle" coords="955,130,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area307" onclick="return checkCoord(307);" class="area test" shape="circle" coords="960,154,3" />
                <area alt="" title="" href="#" state="AC" data-statename="" id="area308" onclick="return checkCoord(308);" class="area test" shape="circle" coords="961,163,3" />
                ...
                <area alt="" title="" href="#" state="AC" data-statename="" id="area310" onclick="return checkCoord(310);" class="area test" shape="circle" coords="972,151,3" />

...
class CabinItems_model extends MY_Model {
	
	private $table 			= 'm_performance_type';
	private $column_order 	= array(null,'name_type',null);
	private $column_search 	= array('id','name_type',null);  
